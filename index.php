...
<body>
    ...
    <div class="content">
        <div class="text">
            <button>
                <svg  class="bi bi-Juandiegoruiz" fill="currentColor" height="16" width="16" xmlns=""> <path d=""></path> </svg>
                    <span>Juan Diego Ruiz Tobon</span>
                </button>
            <p>Soy Estudiante de Ingeniería en Sistemas, actualmente vivo en Flandes/Tolima.
            ...
            <div class="contact-info">
                <p style="z-index: 2; position: relative;">Hablemos!</p>
                <br>
                <div class="tooltip5-container5">
                    <span class="tooltip5">juan.ruiz-t@uniminuto.edu.co</span>
            ...
            <div class="IMG">
                <img src="imagenes/yo_2-removebg-preview.png" alt="">
            </div>
        ...
        <section id="acerca-de" class="section">
            <div class="card">
                ...
                <p class="info">Soy estudiante, apasionado por aprender y siempre en busca de nuevas oportunidades para
                    crecer. Me esfuerzo por mejorar cada día y tengo un fuerte deseo de convertirme en uno de los
                    mejores en
                    mi campo. Estoy abierto a nuevos desafíos y tengo experiencia trabajando con HTML y Figma, además de
                    realizar proyectos freelance. Con mi actitud positiva y determinación, creo que puedo aportar valor
                    y
                    creatividad a cualquier equipo en el que participe.</p>
                <br>
                <br>
                <br>
                <ul class="example-2">
        ...
        <section id="estudios" class="section">
            ...
            <div class="profile-container">
                ...
                <div class="profile-info">
                    ...
                    <p> Ingeniería en Sistemas (2022 - Presente)</p>
                </div>
                <div class="loader3"></div>
                <br>
                <div class="profile-info">
                    ...
                    <ul>
                        <li>Certificado en Python para Ciencias de la Computación, Coursera (2022)</li>
                        <li>Certificado en Fundamentos de Redes de Cisco (2022)</li>
                    </ul>
                </div>
                <div class="loader3"></div>
                <br>
                <div class="profile-info">
                    ...
                    <ul>
                        <li>
                            <strong>Proyecto De Creacion De Un Sistema De Un Cajero Automatico (2023):</strong>
                            Desarrolló una aplicación para gestionar el funcionamiento correcto y mejorado de un cajero
                            automatico.
                        </li>
                        <li>
                            <strong>Desarrollo De Un Sistema De Telefono (2022 - 2023):</strong>
                            Creó un sistema de un telefono utilizando python para iptimisar el sistema de telefono .
                        </li>
                        <li>
                            <strong>Hackathon Tecnológico Univercitario Internacional (2023):</strong>
                            Participó en un hackathon enfocado en soluciones de sostenibilidad. Lideró un equipo de
                            cuatro
                            personas para desarrollar un sistema de seguimiento de usuarios que esten visitando algun
                            lugar
                            no muy conocido usando Python y tecnologías rastreo por señales de radio .
                        </li>
                    </ul>
                </div>
                <div class="loader3"></div>
                ...
                <div class="profile-info">
                    ...
                    <ul>
                        ...
                        <li>Fundamentos de bases de datos: MySQL</li>
                ...
                <div class="profile-info">
                    ...
                    <ul>
                        <li>Participación regular en hackathons y competencias de programación Univercitarias</li>
                    </ul>
                </div>
                <div class="loader3"></div>
                <br>
                <div class="profile-info">
                    ...
                    <ul>
                        <li>Desarrollo de software para causas sociales y sostenibilidad.</li>
                        <li>Practica deportes como el futbol o el microfutbol.</li>
                        <li>Disfruta de la música, jugar videojuego y en mis tiempos libres me gusta investigar de
                            nuevas
                            tecnologias.</li>
                    </ul>
                </div>
        ...
        <section id="portafolio" class="section">
            ...
            <div class="projects">
                <div class="project-card">
                    <h3>Proyecto de Cajero Automático</h3>
                    <p>
                        Desarrollé una aplicación para gestionar el funcionamiento de un cajero automático.
                        Utilicé Python y un framework para interfaces gráficas, mejorando el proceso de transacciones y
                        la
                        seguridad.
                    </p>
                </div>
                ...
                <div class="project-card">
                    <h3>Desarrollo de Sistema Telefónico</h3>
                    <p>
                        Creé un sistema para optimizar la gestión de un centro de llamadas telefónicas.
                        Implementé funciones como el registro de llamadas y el almacenamiento seguro de datos de
                        clientes.
                    </p>
                </div>

                <div class="project-card">
                    <h3>Hackathon Tecnológico Universitario</h3>
                    <p>
                        Participé en un hackathon internacional, liderando un equipo para desarrollar una solución de
                        rastreo de visitantes en lugares poco conocidos.
                        Usamos tecnologías de radiofrecuencia y Python para el seguimiento.
                    </p>
                </div>
            </div>
        </section>
        ...
        <div class="loader"></div>
        <br>
        <section id="contactame" class="contact-section">
            <h2>Contáctame</h2>
            <p>Me encantaría saber de ti. Si tienes alguna pregunta o quieres conectar, aquí están mis datos de
                contacto:
            </p>
            ...
            <div class="contact-infor">
                <div class="contact-card">
                    ...
                    <p1>juan.ruiz-t@uniminuto.edu.co</p1>
                </div>
                <div class="contact-card">
                    <h3>Redes Sociales</h3>
                    <div class="social-icons">
                        <a href="https://github.com/tu-github" target="_blank" class="github-icon">GitHub</a>
                        <a href="https://twitter.com/tu-twitter" target="_blank" class="twitter-icon">Twitter</a>
                        <a href="https://www.instagram.com/tu-instagram" target="_blank"
                            class="instagram-icon">Instagram</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="voltage-button1">
                        ...
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 234.6 61.3"
                            ...
                            <filter id="glow">
                                ...
                                <feTurbulence type="fractalNoise" baseFrequency="0.075" numOctaves="0.3"
        ...
        <footer class="footer">
            <div class="footer-content">
                ...
                <p class="footer-copy">
                    &copy; 2024 Juan Diego Ruiz Tobon. Todos los derechos reservados.
                </p>
            </div>
        </footer>
</body>
